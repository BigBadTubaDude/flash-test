...
const FlashDefectItems = (props) => {
    ...
    return (
        <ul className='Panel2'>
            <Link to='/PaintDefectItems'>Go To paint</Link>
            {ListItems}
        </ul>
    )
}
const  PaintDefectItems = (props) => {
    ////////////////Variables
    const defectTypeList = [
        "SELECT TYPE",
        "Thick Paint",
    ...
    return (
        <ul className='Panel2'>
            <Link to='/FlashDefectItems'>Go To flash</Link>
            {ListItems}
        </ul>
    )
}
export {FlashDefectItems, PaintDefectItems};